    ...
    render(){
        return(
          ...
          <div style={{"backgroundColor":"#fcfcfa"}}>
            ...
            <img src = {"images/bibim.jpg"} alt ="" style={{height: "500px"}}></img> 
            </div>
            </div>
             
             <div class="card" style={{width:"1300px", marginLeft:"110px"}}>
            <div class="card-body">
                <h5 class="card-title" style={{fontSize:"55px"}}>Pork and Veggie Bibmbap</h5><hr/>
          ...
          {/* Utensils */}
           <div className="card" style={{marginTop:"10px", width:"1300px", marginLeft:"110px"}}>
           ...
           <div className="card" style={{marginTop:"10px", width:"1300px", marginLeft:"110px", marginBottom:"10px"}}>
             <div className="card-body">
               <h5>Instruction</h5>
                <div>
                  <p>1. In a small pot, combine rice, 1¼ cups water (2¼ cups for 4 servings), and a big pinch of salt. Bring to a boil, then cover and reduce to a low simmer. 
                    Cook until rice is tender, 15-18 minutes. Keep covered off heat until ready to serve.</p><hr/>
                    <p>2. In a small pot, combine rice, 1¼ cups water (2¼ cups for 4 servings), and a big pinch of salt. Bring to a boil, then cover and reduce to a low simmer. 
                    Cook until rice is tender, 15-18 minutes. Keep covered off heat until ready to serve.</p><hr/>
                    <p>3. In a small pot, combine rice, 1¼ cups water (2¼ cups for 4 servings), and a big pinch of salt. Bring to a boil, then cover and reduce to a low simmer. 
                    Cook until rice is tender, 15-18 minutes. Keep covered off heat until ready to serve.</p><hr/>
                    <p>4. In a small pot, combine rice, 1¼ cups water (2¼ cups for 4 servings), and a big pinch of salt. Bring to a boil, then cover and reduce to a low simmer. 
                    Cook until rice is tender, 15-18 minutes. Keep covered off heat until ready to serve.</p><hr/>
                </div>
             </div>
           </div>
