			...
			<div className="col-md-6 d-flex justify-content-center mx-auto " style={{marginTop:"80px"}}>
				<div className="panel panel-info" >
					<div className="panel-heading">
						<div className="panel-title" style={{fontSize:"30px",fontWeight:"bold",fontFamily:"sans-serif"}}>Enter OTP</div>                        
					</div> 
					<div style={{"paddingTop":"30px"}} className="panel-body" >		
						<form>  					
							<div style={{"marginBottom": "25px" }}>
								<label className="text-success">Check your email for OTP</label>
								<input type="text" className="form-control" id="otp" name="otp" placeholder="One Time Password" style={{width:"600px"}}
								value={otp}
							...
							<div style={{"marginTop":"10px"}} className="form-group">                               
								...
								<input type="submit" name="authenticate" value="Submit" className="btn-success" style={{borderRadius:"10px"}} onClick={verifyOtp}/>						  
								</div>
							</div>                                
						</form>   
					</div>                     
