...
const ViewReview =()=>{
    ...
    return(
       ...
       <div class="row no-gutters">
            ...
            <div> <img src = "images/pro.jpg" height="200px" style={{marginLeft:"30px"}}></img></div>
            ...
            <div class="col-md-8">
                <div className="card" style={{marginTop:"10px", marginRight:"10px", height:"230px"}}>
                    <div class="card-body">
                <h5>Quality</h5>
                <p>Rinse the chicken pieces in cold water and pat dry. Place the chicken in a large, resealable zip-top bag and pour in the marinade.
                     Toss the chicken inside the bag to cover evenly with the marinade and refrigerate for 12 hours or as long as overnight icken pieces in cold water 
                     and pat dry.</p>
                <p>Date: 11/09/2021</p>
