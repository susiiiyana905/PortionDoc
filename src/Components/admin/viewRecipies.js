const ViewRecipies =()=>{
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">PASTO PIZZA WITH FILLAS CHEEZ TOPPINGS</h5>
        <p class="card-text">with White Cheddar & Thyme Mashed Potatoes.</p>
        <p class="card-text"><small class="text-muted">50 min|Fair Climate Score</small></p>
      </div>
    </div>
  </div>
</div>
...
<div class="card mb-3" style={{"width": "1200px","height":"170px"}}>
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <p class="card-text"><small class="text-muted">35 min|Carb Smart• Fair Climate Score</small></p>
      </div>
    </div>
  </div>
</div>
...
<div class="card mb-3" style={{"width": "1200px","height":"170px"}}>
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <p class="card-text"><small class="text-muted">35 min|Veggie • Superstar Climate Score</small></p>
      </div>
    </div>
  </div>
</div>
