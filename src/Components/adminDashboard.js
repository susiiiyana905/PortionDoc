                ...
                <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        ...
                        <ul className="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                            <li className="w-100">
                                <Link to="/addCategory" className="nav-link px-0"> <span className="d-none d-sm-inline">ADD</span> </Link>
                            </li>
                            <li>
                                <Link to ="/" className="nav-link px-0"> <span className="d-none d-sm-inline">View</span> </Link>
                            </li>
                        </ul>
                    </li>
                    <li>
